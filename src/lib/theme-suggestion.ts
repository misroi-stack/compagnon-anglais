...
/**
 * Stats par thème, calculées sur l'ensemble des mots du thème (tous niveaux
 * confondus). Triés du moins avancé au plus avancé pour encourager à
 * travailler les thèmes délaissés (voir PLAN.md, suggestion de session).
 */
