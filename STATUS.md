...
- **Écran de sélection de profil fonctionnel** (`src/app/page.tsx`) : création de profil (nom, mascotte parmi 4 emojis placeholder), sélection — testé dans le navigateur, ça marche
